!(function (y, t, e, n) {
	...
	y.extend(i.prototype, {
			...
			for (var v = o; v <= h; v.setDate(v.getDate())) {
				...
				for (c = 0; c < 7; c++) {
					...
					v.toDateString() === new Date().toDateString() && f.addClass("today"),
						v.getMonth() != t.getMonth() && f.addClass("wrong-month");
					...
					D.length && n.settings.displayEvent
						...
						: f.addClass(n.settings.disableEmptyDetails ? "disabled" : ""),
		...
		changeMonth: function (t) {
			this.currentDate.setMonth(this.currentDate.getMonth() + t),
				...
				var e = new Date(t.startDate),
					...
					a = y(
						'<div class="event"> <div class="event-hour">' +
							...
							s.formatDateEvent(e, n) +
							'</div> <div class="event-summary">' +
							t.summary +
							"</div></div>"
					);
				a.data("event", t),
					a.click(s.settings.onEventSelect),
					s.settings.onEventCreate(a),
					i.append(a);
			});
		},
		fillUp: function (t, e) {
		...
		(y.fn[a] = function (t) {
			return this.each(function () {
				y.data(this, "plugin_" + a) ||
					y.data(this, "plugin_" + a, new i(this, t));
			});
		});
