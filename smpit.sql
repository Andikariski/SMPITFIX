...
--
-- Host: 127.0.0.1
-- Generation Time: Dec 08, 2020 at 03:37 PM
...
--
-- Table structure for table `ui_homeuser`
--
...
CREATE TABLE `ui_homeuser` (
  ...
  `hasilgelombang1` date NOT NULL,
  `hasilgelombang2` date NOT NULL,
  `hasilgelombang3` date NOT NULL,
  `nama_cp` varchar(100) NOT NULL,
  `no_cp` varchar(100) NOT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;

--
-- Dumping data for table `ui_homeuser`
--

INSERT INTO `ui_homeuser` (`id`, `image`, `gelombang1`, `gelombang2`, `gelombang3`, `opengelombang1`, `opengelombang2`, `opengelombang3`, `closegelombang1`, `closegelombang2`, `closegelombang3`, `hasilgelombang1`, `hasilgelombang2`, `hasilgelombang3`, `nama_cp`, `no_cp`) VALUES
(1, 'infopendaftaran.jpeg', 'Pendaftaran Gelombang I', 'Pendaftaran Gelombang II', 'Pendaftaran Gelombang III', '2020-05-22', '2020-05-21', '2020-05-05', '2042-05-23', '2020-05-26', '2031-07-15', '2020-07-07', '2020-07-15', '0000-00-00', 'Andika', '082399770016');
...
(32, 'Akbar aja', 'akbar@gmail.com', 'default.png', '$2y$10$LAw/283yaNuiDozHAYfWHem4Yihce2cBbsu.0R9XV6t1jBkQ08K9e', 2, 0, 1601394625);
...
--
-- AUTO_INCREMENT for table `ui_homeuser`
--
ALTER TABLE `ui_homeuser`
  MODIFY `id` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=2;
