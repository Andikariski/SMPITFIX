...
class Pendaftar extends CI_Controller
{
    ...
    public function bantuanIsiform()
    {
        $data['title'] = 'Bantuan cara mengisi formulir';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar_pendaftar', $data);
        $this->load->view('templates/topbar_pendaftar', $data);
        $this->load->view('pendaftar/bantuan_isiform', $data);
        $this->load->view('templates/footer');
    }

    public function bantuanUploadberkas()
    {
        $data['title'] = 'Bantuan cara upload berkas';
        $this->load->view('templates/header', $data);
        $this->load->view('templates/sidebar_pendaftar', $data);
        $this->load->view('templates/topbar_pendaftar', $data);
        $this->load->view('pendaftar/bantuan_carauploadfile', $data);
        $this->load->view('templates/footer');
    }
}
